...
<body>
  ...
  <header class="site-header">
    ...
    <div class="container header-inner">
      ...
      <a href="https://t.me/tepliy_dom_msk" target="_blank" rel="noopener" class="header-tg" aria-label="Telegram-канал">
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21.5 3.5L2.8 10.3c-.8.3-.8 1.4 0 1.7l4.8 1.6 1.8 5.7c.2.8 1.2.9 1.7.3l2.5-2.6 4.6 3.4c.6.4 1.4.1 1.6-.6l3-15.4c.2-.8-.6-1.4-1.3-1.2zM8.1 13.1l9.8-6.2-7.7 7.9-.3 3.7-1.8-5.4z"/></svg>
      </a>
    </div>
  </header>
    ...
    <div class="container">
      <div class="footer-grid">
        ...
        <div class="footer-col">
          ...
          <a href="https://t.me/Vardan39" target="_blank" rel="noopener">Написать мастеру</a>
          <a href="/contacts">Все контакты</a>
          <div class="footer-tg-channel">
            <a href="https://t.me/tepliy_dom_msk" target="_blank" rel="noopener">
              <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21.5 3.5L2.8 10.3c-.8.3-.8 1.4 0 1.7l4.8 1.6 1.8 5.7c.2.8 1.2.9 1.7.3l2.5-2.6 4.6 3.4c.6.4 1.4.1 1.6-.6l3-15.4c.2-.8-.6-1.4-1.3-1.2zM8.1 13.1l9.8-6.2-7.7 7.9-.3 3.7-1.8-5.4z"/></svg>
              @tepliy_dom_msk
            </a>
            <span>Подписывайтесь на наш канал</span>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="tg-channel-card">
          <div class="tg-channel-info">
            ...
            <div class="tg-channel-name">@tepliy_dom_msk</div>
            <p>Полезные советы по обслуживанию котлов, акции и примеры наших работ</p>
            <ul>
              <li>Советы по уходу за котлом</li>
              <li>Акции и скидки для подписчиков</li>
              <li>Примеры работ до/после</li>
              <li>Быстрая связь с мастером</li>
            </ul>
            <a href="https://t.me/tepliy_dom_msk" target="_blank" rel="noopener" class="tg-subscribe-btn">
              <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M21.5 3.5L2.8 10.3c-.8.3-.8 1.4 0 1.7l4.8 1.6 1.8 5.7c.2.8 1.2.9 1.7.3l2.5-2.6 4.6 3.4c.6.4 1.4.1 1.6-.6l3-15.4c.2-.8-.6-1.4-1.3-1.2zM8.1 13.1l9.8-6.2-7.7 7.9-.3 3.7-1.8-5.4z"/></svg>
              Подписаться
            </a>
          </div>
          <div class="tg-channel-qr">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=https://t.me/tepliy_dom_msk&bgcolor=ffffff&color=2aabee" alt="QR-код Telegram канала @tepliy_dom_msk" width="160" height="160" loading="lazy">
          </div>
        </div>
      </div>
    </section>
